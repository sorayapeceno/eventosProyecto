package dam.primero.config.crm;
...
public class MySqlConectorCRM {
    ...
    public MySqlConectorCRM() throws MyException {
        try {
            Properties properties = new Properties();
            var stream = MySqlConectorCRM.class.getClassLoader()
                    .getResourceAsStream("crm/db.properties");
            if (stream == null) {
